   ...
   <main class="form-signin">
        ...
        <div class="container" style="margin: 5rem auto; text-align: center; border: 3px solid black; padding: 2.1rem 10.1rem; border-radius: 15% 5%; box-shadow: 2px 5px #808080ff">
            ...
            <form id="form1" runat="server">
                ...
                <asp:Label ID="fail" runat="server" CssClass="invalid-feedback" Text="Serial Number entered does not exit, please enter another seria number" Visible="false"></asp:Label>
                    </div>
            </form>
        </div>
    </main>
