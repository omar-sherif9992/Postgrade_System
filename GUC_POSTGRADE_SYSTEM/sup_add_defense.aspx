<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sup_add_defense.aspx.cs" Inherits="GUC_POSTGRADE_SYSTEM.sup_add_defense" %>
  ...
  <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
    <ul class="navbar-nav me-auto">
      ...
      <li class="nav-item">
        ...
        <br />
        <br />
    <h1 style="justify-content:center;font-weight:800;text-align:center;text-decoration:underline">Add Defense</h1> 
    <form id="form1" runat="server">
        <div id="cont" class="container" style="margin:5rem auto;text-align:center; border:3px solid black;padding:2.1rem 10.1rem;border-radius:15% 5%;box-shadow:2px 5px #808080ff">

            Enter Thesis Serial Number<br />
            <asp:TextBox ID="ThesisSerial" class="form-control" runat="server" placeholder="Thesis Serial Number" type="number"></asp:TextBox>
            ...
            <asp:TextBox ID="DefenseLocation" class="form-control" runat="server" placeholder="Defense Location" ></asp:TextBox>



            <br />
            <br />
            <asp:Button ID="Submit" runat="server" Text="Add Defense" class="btn btn-outline-primary btn-lg" OnClick="Add"/>
            <br />
            <asp:Label ID="kalam" runat="server" style="font-size:xx-large"></asp:Label>



            <br />
            <br />
            <asp:Button ID="Home" runat="server" class="btn btn-outline-secondary btn-lg" Text="Home Page" OnClick="home" />
            </br>
