<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Examiner_Add_comments.aspx.cs" Inherits="GUC_POSTGRADE_SYSTEM.Examiner_Add_comments" %>
...
<body>
  ...
  <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
    ...
    <ul class="navbar-nav me-auto">
        ...
        <li class="nav-item">
        <a class="nav-link" href="Examiner_Add_grades.aspx">Add grades</a>
      </li>
        <li class="nav-item">
    ...
    <h1 style="justify-content:center;font-weight:800;text-align:center;text-decoration:underline">Add Comments</h1>
        ...
        <asp:TextBox class="form-control" ID="newComment" runat="server"  placeholder="Enter your comments"></asp:TextBox>

                <asp:Label ID="Label1" runat="server" Text="comments are added" Visible="false"></asp:Label>
               <asp:Label ID="Label2" runat="server" Text="the date chosen or the serial number is incorrect" Visible="false"></asp:Label>
               <p>
            <asp:Button ID="addComment" runat="server" OnClick="AddComments" Text="Add Comment" Width="172px" class="btn btn-outline-primary btn-lg" />
        </p>
    </form>
        </div>
</body>
