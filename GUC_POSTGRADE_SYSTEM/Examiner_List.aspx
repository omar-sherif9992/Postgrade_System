<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Examiner_List.aspx.cs" Inherits="GUC_POSTGRADE_SYSTEM.Examiner_List" %>
...
<body>
  ...
  <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
    ...
    <form id="form1" runat="server">
        <h1 style="justify-content:center;font-weight:800;text-align:center;text-decoration:underline">The List</h1> 
         <h1 style="justify-content:center;font-weight:800;text-align:center;text-decoration:underline"> </h1>
        
        <div>
             
            <asp:GridView ID="ListTable" runat="server" AutoGenerateColumns ="false">
               <columns>    
                   <asp:BoundField HeaderText="Thesis Title" DataField="title"/> 
                   <asp:BoundField HeaderText="Student's first name" DataField="firstName"/> 
                   <asp:BoundField HeaderText="Student's last name" DataField="lastName"/> 
                   <asp:BoundField HeaderText="Supervisor's name" DataField="name"/> 
